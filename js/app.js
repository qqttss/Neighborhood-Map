...
function initMap() {
    ...
    // execute custom function within infobox script
    loadInfoBox();
    ...
    var Pin = function Pin(map, name, lat, lng, link, infobox) {
        ...
        self.clickForInfoBox = function() {
            ...
            // use setTimeout to stop marker from bouncing
    ...
    var viewModel = function(attractions) {
        ...
        //control if location list is hidden or displayed
        self.toggleListBoolean = ko.observable(true);
        //function that hide or display location list
        ...
        attractions.forEach(function(point) {
            self.pins.push(new Pin(map, point.name, point.lat, point.lng, point.link));
